<%@ Page Title="Historical Rankings" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistoricalRankings.aspx.cs" Inherits="CFMStats.HistoricalRankings" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="row">
        <div class="col-sm-12">
            <h2>Historical Team Rankings</h2>
            <p>Track team performance across seasons</p>
        </div>
    </div>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="table-responsive">
                <asp:Literal ID="litHistoricalRankings" runat="server"></asp:Literal>
            </div>
