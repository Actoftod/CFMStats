...
{
    public partial class ucTeamRecordDefensiveStats : System.Web.UI.UserControl
    {
        ...
        {
            Fetch(LeagueId, Duration, "Tackles");
            Fetch(LeagueId, Duration, "Sacks");
            Fetch(LeagueId, Duration, "Interceptions");
        ...
        private void Fetch(int leagueId, string duration, string category)
        {
            ...
            {
                case "Tackles":
                    tableTackles.InnerHtml = string.Empty;
                    break;
                case "Sacks":
                    tableSacks.InnerHtml = string.Empty;
                    break;
                case "Interceptions":
                    tableInterceptions.InnerHtml = string.Empty;
                    break;
                case "Touchdowns":
            ...
            {
                Name = "records.TeamDefensiveStats",
            ...
            sbTable.Append("<table id='defensiverecords' class='table table-condensed table-bordered tablesorter' >");
            ...
            {
                case "Tackles":
                    tableTackles.InnerHtml = sbTable.ToString();
                    break;
                case "Sacks":
                    tableSacks.InnerHtml = sbTable.ToString();
                    break;
                case "Interceptions":
                    tableInterceptions.InnerHtml = sbTable.ToString();
                    break;
                case "Touchdowns":
